# run.do - compile & simulate all NTT testbenches in ModelSim/Questa
# Usage: cd sim && vsim -c -do run.do
#   or:  vsim -do run.do   (GUI mode)

set TB_DIR ../tb
set RTL_DIR ../rtl

# copy data files into sim/ so $readmemh and $fopen find them
...
# ---- run each testbench ----
# Auto-resume macro after $finish break (ModelSim 10.1 compat)
onbreak resume
...
run_tb tb_barrett
run_tb tb_butterfly_comb
run_tb tb_butterfly2
run_tb tb_tw_exp
run_tb tb_rotate
run_tb tb_ntt_top
